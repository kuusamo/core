 ...
 */
class Setting extends \Kuusamo\Vle\Entity\Setting implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kuusamo\\Vle\\Entity\\Setting' . "\0" . 'key', '' . "\0" . 'Kuusamo\\Vle\\Entity\\Setting' . "\0" . 'value'];
        }
    ...
    public function setKey(string $value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setKey', [$value]);
