 ...
 */
class File extends \Kuusamo\Vle\Entity\File implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kuusamo\\Vle\\Entity\\File' . "\0" . 'id', '' . "\0" . 'Kuusamo\\Vle\\Entity\\File' . "\0" . 'name', '' . "\0" . 'Kuusamo\\Vle\\Entity\\File' . "\0" . 'filename', '' . "\0" . 'Kuusamo\\Vle\\Entity\\File' . "\0" . 'mediaType', '' . "\0" . 'Kuusamo\\Vle\\Entity\\File' . "\0" . 'size', '' . "\0" . 'Kuusamo\\Vle\\Entity\\File' . "\0" . 'folder'];
        }
    ...
    public function setSize(int $value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSize', [$value]);
     ...
     * {@inheritDoc}
     */
    public function getFolder(): ?\Kuusamo\Vle\Entity\Folder
    {
     ...
     * {@inheritDoc}
     */
    public function setFolder(?\Kuusamo\Vle\Entity\Folder $value)
    {

        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setFolder', [$value]);

        return parent::setFolder($value);
    }
