 ...
 */
class ApiKey extends \Kuusamo\Vle\Entity\ApiKey implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Kuusamo\\Vle\\Entity\\ApiKey' . "\0" . 'key', '' . "\0" . 'Kuusamo\\Vle\\Entity\\ApiKey' . "\0" . 'secret', '' . "\0" . 'Kuusamo\\Vle\\Entity\\ApiKey' . "\0" . 'description'];
        }
